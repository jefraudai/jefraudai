...
def get_service_secrets(service):
    ...
    service_secrets_map = {
        ...
        "Producer": ["KAFKA_PASSWORD", "KAFKA_BOOTSTRAP_SERVERS", "KAFKA_USERNAME", "KAFKA_CA_CERT"],
        "consumer": ["KAFKA_PASSWORD", "KAFKA_BOOTSTRAP_SERVERS", "KAFKA_USERNAME", "KAFKA_CA_CERT", "POSTGRES_URI", "MLFLOW_POSTGRES_URI", "MLFLOW_S3_ENDPOINT_URL"],
    }
